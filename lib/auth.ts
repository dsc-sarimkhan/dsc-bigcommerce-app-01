...
const logTitle=" auth.ts :: ";
console.log(logTitle + "API_URL", API_URL);
console.log(logTitle + "LOGIN_URL", LOGIN_URL);
console.log(logTitle + "JWT_KEY", JWT_KEY);
console.log(logTitle + "AUTH_CALLBACK", AUTH_CALLBACK);
console.log(logTitle + "CLIENT_ID", CLIENT_ID)
console.log(logTitle + "CLIENT_SECRET", CLIENT_SECRET);
...
export function getBCAuth(query: QueryParams) {
    var logTitle=" getBCAuth() ";
    try{
        console.log(logTitle+"bigcommerce", bigcommerce)
